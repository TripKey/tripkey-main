...
const OnboardingPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-linear-to-b from-muted/50 to-background px-4 py-12">
      <div
        className={cn(
          'w-full max-w-5xl overflow-hidden rounded-3xl border border-border bg-card shadow-xl transition-all duration-500 ease-out',
          shown
