# TripKey Claude Code Prompt Set

> Claude Code에서 복붙해서 사용한다.
> @ 태그로 필요한 파일만 골라 읽게 한다.
...
```text
Read @CLAUDE.md and @shared/docs/agent/review/backend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @CLAUDE.md and @shared/docs/agent/review/frontend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @CLAUDE.md and @shared/docs/agent/review/ai-engine-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
@shared/docs/agent/review/ai-engine-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
@shared/docs/agent/review/backend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @CLAUDE.md and @shared/docs/agent/review/core-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
