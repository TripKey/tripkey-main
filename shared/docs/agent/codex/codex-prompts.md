...
```text
Read @AGENTS.md and @shared/docs/review/backend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @AGENTS.md and @shared/docs/review/frontend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @AGENTS.md and @shared/docs/review/ai-engine-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
@shared/docs/review/ai-engine-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
@shared/docs/review/backend-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
...
```text
Read @AGENTS.md and @shared/docs/review/core-review.md first.
Do not modify any .md files without explicit permission.
Do not edit files.
